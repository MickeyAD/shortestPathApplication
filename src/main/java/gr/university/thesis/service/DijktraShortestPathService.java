...
public class DijktraShortestPathService {
    ...
    public void dijktraAlgorithmDistanceCost(Station start, Station end) {
         ...
         */
        for (Edge e : start.getAdjacentEdges()) {
            shortestPath.put(e.getDestination(), e.getDistanceCost());
            successor.put(e.getDestination(), start);
        }
